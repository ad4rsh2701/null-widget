...
// @param instance: Handle to the executable, basically an identifier
...
int WINAPI WinMain(HINSTANCE instance, HINSTANCE, LPSTR, int){
    ...
    // a class is a template for an object, the closest thing to
    ...
    widgetTemplate.hCursor = LoadCursor(nullptr, IDC_ARROW);            // Load the default cursor on hover
    ...
    CreateWindowExW(
        WS_EX_TOOLWINDOW,                           // Hide executable from the taskbar
        ...
        nullptr, nullptr, instance, nullptr          // NO.
    );
    ...
    menuTemplate.hCursor = LoadCursor(nullptr, IDC_ARROW);
    ...
    // you know... those MACROS THAT EXPAND TO HEX.
    ...
    // with that MACRO.
    while (GetMessageW(&eventMsg, nullptr, 0, 0)) {

        //      TranslateMessage translates those Macros to
        //      meaningful things I guess, I am assuming those
        ...
        // only complexity is dragging, and mouse click doesn't
        // need extra info.
        //
        ...
        // cuz we need to spoon-feed these event messages windows
    ...
    // Classic, but inconvenient. And I am not creating
...
// I am so done with typedefs and expands to hex,
// In my honest opinion, WinAPI isn't bad, it's
// intuitive... just in a very ancient kind of way.
// Sigh, why am I still using Windows!?
